module ImageGalleryContextPanel
  #css selectors 
  #image gallery element
  @image_gallery_element = '[data-test="draggable-element-image-gallery"]'
  ...
  def self.focused_element
    @browser.element(css: @image_gallery_element).fire_event "mousedown"
    return self
  end
