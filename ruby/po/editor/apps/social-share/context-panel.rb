module SocialShareContextPanel
  #css selectors 
  #social share element
  @social_share_element = '[data-test="draggable-element-social-share"]'
  ...
  def self.focused_element
    @browser.element(css: @social_share_element).fire_event "mousedown"
    return self
  end
